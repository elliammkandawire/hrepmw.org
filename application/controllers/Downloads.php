...
class Downloads extends BaseController {
	...
	private $admin_url="downloads_admin";
	public $per_page=8;
	...
	public function addDefaultData(){
		$data=array(
			...
			"url"=>$this->input->post("current_link")
		);

		/*check if picture is empty*/
		if ($_FILES['file']['error']!=4) {
			$file_name=$this->do_upload("assets/doc/","file")['upload_data']['file_name'];
			$data['url']=$this->createPictureUrl("assets/doc/",$file_name);
		}
