...
class Team extends BaseController {
	...
	public function admin_dashboard(){
		$ref=null;
		if(isset($_GET['page'])){
			$ref=$this->clean($this->input->get("page"));
		}
	...
	public function addDefaultData(){
		$data=array(
			...
			"display_position"=>$this->removeHtmlTags($this->input->post("display_position")),
		...
		if ($_FILES['picture']['error']!=4) {
			...
			$data['picture']=$this->createPictureUrl("assets/images/team/",$file_name);
		}
