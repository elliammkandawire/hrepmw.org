...
<div class="col-lg-9"><!--start col-lg-4-->
	<div class="w3-card-16">
		...
		<header class="w3-container main-color">
			<h5 style="color: whitesmoke">News Features</h5>
	...
	<div id="container" style="width: 100%;">
		<?php foreach($data as $item): ?>
			<div class="gallery w3-container">
				<a target="_blank" href="<?php echo $item->newspaper_screenshot; ?>">
					<img src="<?php echo $item->newspaper_screenshot; ?>" alt="" style="object-fit: cover; height: 200px;" >
				</a>
				<div class="desc"><?php echo $item->title;  ?></div>
				<div class="container">
					<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit" data-whatever="@mdo" onclick="edit_feature('<?php echo $item->slug; ?>')"><i class="fa fa-edit"></i></button>
					<button class="btn btn-warning btn-sm" onclick="delete_('<?php echo $item->slug; ?>','<?php echo $item->title; ?>','Confirm deleting announcement with title ','features/delete')"><i class="fa fa-trash"></i></button>
				</div>
			</div>
		<?php endforeach; ?>
	</div>
	...
	<div class="modal-dialog" role="document" style="width: 50%">
		<div class="modal-content">
			...
			<div class="modal-body">
				<?php echo form_open_multipart('Features/addNew');?>
				<div class="row">
					<div class="col-lg-6">
	...
	<div class="modal-dialog" role="document" style="width: 50%;">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="POST" action="<?php echo base_url() ?>Features/EditExisting" enctype="multipart/form-data">
					<div class="row">
						<div class="col-lg-6">
