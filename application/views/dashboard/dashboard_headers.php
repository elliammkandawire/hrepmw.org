...
<div class="col-lg-9"><!--start col-lg-4-->
	<div class="w3-card-16">
		...
		<header class="w3-container main-color">
			<h5 style="color: whitesmoke">HEADERS</h5>
		...
		<?php foreach($data as $item): ?>
			<div class="gallery w3-container">
				<a target="_blank" href="<?php echo $item->image_url; ?>">
					<img src="<?php echo $item->image_url; ?>" alt="" style="object-fit: cover; height: 200px;" >
				</a>
				<div class="desc"><?php echo $item->menu_name;  ?></div>
				<div class="container">
					<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit" data-whatever="@mdo" onclick="edit_header('<?php echo $item->slug; ?>')"><i class="fa fa-edit"></i></button>
				</div>
			</div>
		<?php endforeach; ?>
	</div>
	...
	<div class="modal-dialog" role="document" style="width: 50%;">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="POST" action="<?php echo base_url() ?>headers/EditExisting" enctype="multipart/form-data">
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="form-group">
								<label for="message-text" class="col-form-label">Menu Name</label>
								<input  type="text" class="form-control" readonly name="menu_name" id="menu_name">
							</div>
