	...
	<div id="container" style="width: 100%;" class="jumbotron">
		...
		<table class="w3-table w3-table-stripped table-bordered">
			...
			<?php foreach($data as $item): ?>
				...
				<td>
					<button style="margin-bottom: 5px" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit" data-whatever="@mdo" onclick="edit_announcement('<?php echo $item->slug; ?>')"><i class="fa fa-edit"></i></button>
					<button class="btn btn-warning btn-sm" onclick="delete_('<?php echo $item->slug; ?>','<?php echo $item->title; ?>','Confirm deleting news with title ','announcements/delete')"><i class="fa fa-trash"></i></button></td>
				</tr>
			<?php endforeach; ?>
			</tr>
			</tbody>
	...
	<div class="modal-dialog" role="document" style="width: 40%">
		<div class="modal-content">
			...
			<div class="modal-body">
				<?php echo form_open_multipart('announcements/addNew');?>
				<div class="col-lg-6">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<?php echo form_open_multipart('announcements/EditExisting');?>
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="form-group">
							<label for="message-text" class="col-form-label">Short Description:</label>
							<textarea class="form-control summernote" rows="15" id="short_description" name="short_description" style="white-space: pre-wrap;"></textarea>
						</div>
