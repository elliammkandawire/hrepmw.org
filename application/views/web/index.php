...
<!--Main Slider Start-->
<section class="main-slider" style="margin-top: -30px;">
		...
		<div class="swiper-wrapper" style="height: 700px;">
			<?php foreach ($sliders as $slider): ?>
				<div class="swiper-slide">
					<div class="image-layer" style="background-image: url(<?php echo $slider->image ?>);">
					</div>
					<!-- /.image-layer -->
					<div class="container">
						<div class="row">
							<div class="col-xl-7">
								<div class="main-slider__content">
									<h2 style="font-size: 70px;"><?php echo $slider->description ?></h2>
									<br>
<!--									<p>--><?php //echo $slider->title ?><!--</p>-->
									<a href="<?php echo base_url() ?>projects" class="thm-btn">Discover More</a>
									<div class="main-slider-shape-1"><img src="#" class="float-bob-x" alt=""></div>
								</div>
							</div>
						</div>
					</div>
...
<section class="we-believe">
	...
	<div class="container">
		<div class="section-title text-center">
			<h2 class="section-title__title"><?php echo $company_data->fullname; ?></h2>
			<h4 class="we-believe__title"><?php  echo $company_data->motto; ?></h4>
		</div>
		<div class="row">
			<div class="col-xl-12">
				<ul class="list-unstyled we-believe__list">
					...
					<?php foreach ($programs as $program): ?>
						<li class="we-believe__single wow fadeInUp" data-wow-delay="<?php echo $program->delay  ?>">
							<div class="we-believe__icon">
								<span class="<?php echo $program->icon ?>"></span>
							</div>
							<h3 class="we-believe__title"><a href="<?php echo base_url()."programs/".$program->slug ?>"><?php echo $program->title ?></a></h3>
							<p class="we-believe__text"><?php echo $program->short_description ?></p>
						</li>
					<?php endforeach; ?>
				</ul>
			</div>
...
<!--						<p class="welcome-one__text-1">Pifoxen is the largest global crowdfunding.</p>-->
						<p class="welcome-one__text-2"><?php echo $company_data->short_aboutus ?></p>
						<div class="welcome-one__btn-box">
							<a href="<?php echo base_url() ?>about" class="thm-btn welcome-one__btn">Discover More</a>
	...
	<section class="causes-one">
		<div class="container">
			<div class="section-title text-left">
				<span class="section-title__tagline">Get to know</span>
				<h2 class="section-title__title">Latest Trends</h2>
			</div>
			<div class="row">
				...
				<section class="two-boxes">
					<div class="container">
						<div class="row">
							<?php foreach ($moh_announcements as $announcement): ?>
			...
			<div class="two-section__testimonial">
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="testimonial-one__img-holder">
								<img style="object-fit: cover; height: 70px" src="<?php echo $event->picture ?>" alt="">
							</div>
						</div><!-- /.swiper-slide -->
						<?php endforeach; ?>
					</div>
				...
				<div class="testimonials-one__main-content">
					<div class="swiper-container" id="testimonials-one__carousel">
						<div class="swiper-wrapper">
							<?php foreach ($events_latest as $event_details): ?>
							<div class="swiper-slide">
								<div class="testimonial-one__conent-box">
									<p class="testimonial-one__text"><?php echo substr($event_details->content,0,200) ?>...</p>
									<div class="testimonial-one__client-details">
										<a href="<?php echo base_url()."event-details/".$event_details->slug ?>"><h4 class="testimonial-one__client-name">- <?php echo ucwords($event_details->title) ?></h4></a>
									</div>
								</div>
							</div><!-- /.swiper-slide -->
							<?php endforeach; ?>
				...
				<div class="col-xl-12">
					<div class="quality-work__tab-box tabs-box">
						<ul class="tab-buttons clearfix list-unstyled">
							<li data-tab="#approach" class="tab-btn active-btn"><span>Announcements</span></li>
							<li data-tab="#inspiration" class="tab-btn"><span>Recent News</span></li>
							<li data-tab="#difference" class="tab-btn"><span>Recent Documentation</span></li>
						</ul>
			...
			<div class="row">
				<div class="col-xl-6 col-lg-6 wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
					...
					<div class="feature-one__single">
						...
						<div class="feature-one__content">
							<h4 class="feature-one__title">Our Mission</h4>
							<p class="feature-one__text"><?php echo $company_data->mission ?></p>
						</div>
						<a href="<?php echo base_url() ?>about" class="feature-one__btn">More</a>
					</div>
				</div>
				<div class="col-xl-6 col-lg-6 wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
					...
					<div class="feature-one__single feature-one__single-2">
						...
						<div class="feature-one__content">
							<h4 class="feature-one__title">Our Vision</h4>
							<p class="feature-one__text"><?php echo $company_data->vision ?></p>
						</div>
						<a href="<?php echo base_url() ?>about" class="feature-one__btn">More</a>
					</div>
				</div>
